...
const ContactUs = () => {
  return (
    <>
      <section className="md:max-w-[1240px] md:mx-auto flex justify-center mx-4  bg-white py-20 lg:py-[50px] overflow-hidden  ">
        <div className="container">
          <div className="flex flex-wrap  lg:justify-between">
            <div className="md:w-full lg:w-1/2 xl:w-6/12">
